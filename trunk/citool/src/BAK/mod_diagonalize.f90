...
!************************************************************************
  SUBROUTINE avmult_x(dimat, imat, jmat, vmat, vap, wap)
    ...
    INTEGER,    INTENT(IN) :: imat(dimat+1), jmat(:)
    COMPLEX*16, INTENT(IN) :: vmat(:)
...
INTEGER, INTENT(IN) :: numevecs
REAL*8,  INTENT(OUT) :: evals(numevals)
REAL*8,  INTENT(OUT) :: evecs(dimham,numevecs)
...
!!$!************************************************************************
  ...
  SUBROUTINE avmult(dimat, imat, jmat, vmat, vap, wap)
    ...
    INTEGER,    INTENT(IN) :: dimat
    INTEGER,    INTENT(IN) :: imat(dimat+1), jmat(:)
    REAL*8, INTENT(IN) :: vmat(:)
    REAL*8, INTENT(IN) :: vap(dimat)
    REAL*8, INTENT(OUT) :: wap(dimat)
